...
[AIの回避パターン（Zenn）](https://zenn.dev/odakin/articles/epstein-ai-evasion-digest)｜[エプスタイン事件の実質](https://zenn.dev/odakin/articles/epstein-substack-digest)｜[AI Evasion Patterns (dev.to)](https://dev.to/odakin/chatgpt-thought-suspicious-but-wrote-unlikely-4p1o)
:::
